...
class demo2:
    ...
    def vis_detections(self, ax, im, score, dets, bbox_type):
        #im = im[:, :, (2, 1, 0)]
        ...
        angle = score
        r_bbox = self.Rotate2D(pts, cnt, -np.pi/2-np.pi/20*(angle-1))
    ...
    def get_Realworld_coordinates(image):
    ...
    def my_single_prediction(method_access, item_id=0):
        ...
        # for index in range(1):
            ...
            if(method_access == 1):
                ...
                img = io.imread('/home/pranay/catkin_ws/img_rgd_pakad')
